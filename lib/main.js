    ...
    switch (pressedButton) {
      case "fourteen":
        ...
        pie.series[0].setData([
          ['Mobile', mobileSum.slice(0,14)],
          ['Tablet', tabletSum.slice(0,14)],
          ['Desktop', desktopSum.slice(0,14)]
        ]);
        break;
      case "seven":
        chart.series[0].setData(activitySums.slice(7,14));
        pie.series[0].setData([
          ['Mobile', mobileSum.slice(7,14)],
          ['Tablet', tabletSum.slice(7,14)],
          ['Desktop', desktopSum.slice(7,14)]
        ]);
        break;
      case "three":
        chart.series[0].setData(activitySums.slice(11,14));
        pie.series[0].setData([
          ['Mobile', mobileSum.slice(11,14)],
          ['Tablet', tabletSum.slice(11,14)],
          ['Desktop', desktopSum.slice(11,14)]
        ]);
        break;
      case "today":
