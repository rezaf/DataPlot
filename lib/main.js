(function() {
  ...
  var fourteenChart = DataPlot.fourteenChart = function() {
    ...
    segSums(0, 14);
    chart.series[1].setData(calcTrend(activitySums.slice(0, 14)));
  };
  ...
  var sevenChart = DataPlot.sevenChart = function() {
    ...
    chart.series[1].setData(calcTrend(activitySums.slice(7, 14)));
    pie.series[0].setData([
  ...
  var threeChart = DataPlot.threeChart = function() {
    ...
    chart.series[1].setData(calcTrend(activitySums.slice(11, 14)));
    pie.series[0].setData([
